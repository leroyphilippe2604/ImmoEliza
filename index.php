            ...
            <div class="col-10 col-md-5 mx-auto formulaire pl-1 pl-md-2 pr-0 py-4">
                ...
                <form class="col-12 px-0" method="post" action="">
                    ...
                    <div class="col-12 d-flex">
                        ...
                        <div class="col-4 p-0">
                            <input type="number" min="0" max="6000" class="post_code  w-100" name="post_code" required>
                        </div>
                    </div>
                    <!--Type of property-->
                    ...
                    <div class="col-12 d-flex align-items-center mb-1">
                        ...
                        <div class="col-4 p-0">
                            <input type="number" min="0" max="1000" class="living_area  w-100" name="living_area" required>
                        </div>
                    </div>
                    <!--Number rooms-->
                    <div class="col-12 d-flex align-items-center mb-1">
